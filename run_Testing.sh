...
#    ARGS=(${MTHD} ${idx_job} ${LOGDIR} ${DATE} ${VARS})
#    echo ARGUMENTS
#    echo "${ARGS[*]}"
#
#    msub -N agent-${idx_job} -j oe -o $MSUB_OUTPUT/test_output.o${idx_job} -v SCRIPT_FLAGS="${ARGS[*]}" -l ${JOB_RESOURCES} /home/fr/fr_fr/fr_mv135/src/RLAgentsFlappyBird/run_test_agent.sh
#done
...
#    echo -e "Submitting agent: "${idx_job}
    ...
    msub -N agent -j oe -o $MSUB_OUTPUT/test_output.o${idx_job} -v SCRIPT_FLAGS="${ARGS[*]}" -l ${JOB_RESOURCES} /home/fr/fr_fr/fr_mv135/src/RLAgentsFlappyBird/run_test_agent.sh
done