...
PYCMD="python3.6 /home/fr/fr_fr/fr_mv135/src/RLAgentsFlappyBird/tracking.py --lr $LR --method $MTHD --logdir $LOGDIR --test_env $TEST_ENV --total_timesteps $TOTAL_TESTSTEPS --restore_model True"
